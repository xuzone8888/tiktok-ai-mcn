...
- Published privacy contact: `developer@toryxai.com`; confirm it is actively monitored and identify the responsible privacy/legal role.
...
- Contact: CEO, `developer@toryxai.com`; confirm the mailbox is actively monitored.
