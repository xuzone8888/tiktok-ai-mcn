...
export default function PublishPage() {
    ...
    const generateAllTitles = async () => {
        ...
        const count = selectedVideos.length || 1
                            ...
                            {titleMode === 'individual' && (
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => setShowTitleAssistant(true)}
                                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r from-purple-500/20 to-pink-500/20 hover:from-purple-500/30 hover:to-pink-500/30 text-pink-300 transition-all text-sm font-medium border border-pink-500/20 hover:border-pink-500/40 shadow-lg shadow-pink-500/5"
                                    >
                                        <Sparkles className="w-3.5 h-3.5" />
                                        AI 写标题
                                    </button>
            ...
            {/* AI Title Assistant Modal */}
            {
                showTitleAssistant && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-xl p-4">
                        <div className="relative bg-neutral-950/95 backdrop-blur-2xl rounded-2xl border border-white/[0.08] w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col" style={{ boxShadow: '0 25px 70px -15px rgba(168,85,247,0.25), inset 0 1px 0 rgba(255,255,255,0.05)' }}>
                            {/* Top accent */}
                            ...
                            <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.06]">
                                <div className="flex items-center gap-3">
                                    <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/15 flex items-center justify-center" style={{ boxShadow: '0 0 16px rgba(168,85,247,0.2)' }}>
                                        <Sparkles className="w-4.5 h-4.5 text-purple-400" />
                                    </div>
                                    <div>
                                        <h3 className="text-[16px] font-bold text-white tracking-tight">AI 标题助手</h3>
                                        <p className="text-[11px] text-white/30">智能生成吸引眼球的视频标题</p>
                                    </div>
                                </div>
                                <button
                                    onClick={() => {
                                    ...
                                    className="w-8 h-8 flex items-center justify-center rounded-lg bg-white/[0.04] border border-white/[0.06] text-white/40 hover:text-white/70 hover:bg-white/[0.08] transition-all"
                                >
                                    <X className="w-4 h-4" />
                                </button>
                            </div>
                            ...
                            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
                                ...
                                {generatedTitles.length === 0 && !generatingTitles && (
                                    <>
                                        <div>
                                            <label className="flex items-center gap-1.5 text-[13px] font-semibold text-white/60 mb-2.5">
                                            ...
                                            <textarea
                                                ...
                                                rows={4}
                                                className="w-full px-4 py-3 bg-white/[0.03] border border-white/[0.06] rounded-xl text-[14px] text-white placeholder-white/20 focus:outline-none focus:border-purple-500/30 focus:bg-white/[0.04] transition-all resize-none"
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-3">
                                                <button
                                                    ...
                                                    className={`flex-1 py-3.5 rounded-xl border transition-all duration-200 text-center ${titleLanguage === 'zh'
                                                        ? 'border-purple-500/30 bg-purple-500/[0.08] text-white'
                                                        : 'border-white/[0.06] bg-white/[0.02] text-white/35 hover:text-white/60 hover:border-white/[0.1]'
                                                        }`}
                                                    style={titleLanguage === 'zh' ? { boxShadow: '0 0 20px rgba(168,85,247,0.12)' } : undefined}
                                                >
                                                    <div className="text-[15px] font-bold">CN</div>
                                                    <div className="text-[12px] mt-0.5 opacity-70">中文</div>
                                                </button>
                                                <button
                                                    onClick={() => setTitleLanguage('en')}
                                                    className={`flex-1 py-3.5 rounded-xl border transition-all duration-200 text-center ${titleLanguage === 'en'
                                                        ? 'border-purple-500/30 bg-purple-500/[0.08] text-white'
                                                        : 'border-white/[0.06] bg-white/[0.02] text-white/35 hover:text-white/60 hover:border-white/[0.1]'
                                                        }`}
                                                    style={titleLanguage === 'en' ? { boxShadow: '0 0 20px rgba(168,85,247,0.12)' } : undefined}
                                                >
                                                    <div className="text-[15px] font-bold">US</div>
                                                    <div className="text-[12px] mt-0.5 opacity-70">English</div>
                                                </button>
                                            </div>
                                        </div>

                                        <div className="flex items-center gap-2 px-4 py-3 rounded-xl bg-white/[0.02] border border-white/[0.05]">
                                            <BarChart3 className="w-4 h-4 text-purple-400/50 shrink-0" />
                                            <span className="text-[13px] text-white/35">
                                            将为 <span className="text-purple-400 font-semibold">{selectedVideos.length || 1}</span> 个视频生成标题
                                            </span>
                                        </div>
                                    </>
                                )}
                                ...
                                {generatingTitles && (
                                    <div className="py-14 text-center">
                                        <div className="w-16 h-16 mx-auto mb-5 rounded-2xl bg-gradient-to-br from-purple-500/15 to-pink-500/15 border border-purple-500/10 flex items-center justify-center" style={{ boxShadow: '0 0 30px rgba(168,85,247,0.15)' }}>
                                            <Loader2 className="w-8 h-8 animate-spin text-purple-400" />
                                        </div>
                                        <p className="text-[15px] font-semibold text-white/60 mb-1">AI 正在生成标题...</p>
                                        <p className="text-[12px] text-white/25">正在为 {selectedVideos.length || 1} 个视频创作吸引力标题</p>
                                    </div>
                                )}
                                    ...
                                    <>
                                        ...
                                        <div className="space-y-2.5 max-h-[400px] overflow-y-auto pr-1">
                                            {generatedTitles.map((title, index) => (
                                                <div
                                                    key={index}
                                                    className={`p-3.5 rounded-xl border transition-all duration-200 ${title.selected
                                                ...
                                                >
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`flex-shrink-0 w-5 h-5 rounded-md border transition-all mt-2 flex items-center justify-center ${title.selected
                                                                ? 'bg-purple-500 border-purple-400'
                                                                : 'border-white/20 hover:border-white/40 bg-white/[0.03]'
                                                                }`}
                                                            style={title.selected ? { boxShadow: '0 0 8px rgba(168,85,247,0.3)' } : undefined}
                                                        >
                                                            {title.selected && <Check className="w-3.5 h-3.5 text-white" />}
                                                        </button>

                                                        {/* Title Input */}
                                                        <div className="flex-1">
                                                            <span className="text-[11px] text-white/25 font-medium">视频 {index + 1}</span>
                                                            <textarea
                                                                value={title.content}
                                                                onChange={(e) => updateTitleContent(index, e.target.value)}
                                                                rows={2}
                                                                className="w-full mt-1 px-3 py-2 bg-white/[0.03] border border-white/[0.06] rounded-lg text-[13px] text-white focus:outline-none focus:border-purple-500/30 resize-none transition-colors"
                                                            />
                                                        </div>
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-lg text-white/25 hover:text-purple-400 hover:bg-purple-500/10 transition-all mt-1 disabled:opacity-30"
                                                            title="重新生成"
                                                        >
                                ...
                                {generatedTitles.length === 0 ? (
                                    <>
                                        <button
                                            ...
                                            className="px-4 py-2.5 rounded-xl bg-white/[0.04] border border-white/[0.06] text-[13px] text-white/40 hover:text-white/60 hover:bg-white/[0.06] transition-all"
                                        >
                                            取消
                                        </button>
                                        <button
                                            ...
                                            className="px-6 py-2.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-[13px] font-semibold text-white hover:opacity-90 transition-opacity disabled:opacity-30 disabled:cursor-not-allowed flex items-center gap-2"
                                        ...
                                        <div className="flex items-center gap-2">
                                            {generatedTitles.filter(t => !t.selected).length > 0 && (
                                                <button
                                                    ...
                                                    disabled={regeneratingIndex !== null}
                                                    className="px-3 py-2 rounded-xl bg-white/[0.04] border border-white/[0.06] text-[12px] text-white/35 hover:text-white/55 hover:bg-white/[0.06] transition-all flex items-center gap-1.5 disabled:opacity-30"
                                                >
                                                    <RefreshCw className="w-3 h-3" />
