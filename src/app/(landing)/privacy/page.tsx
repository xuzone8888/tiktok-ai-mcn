      ...
      <main className="relative z-10 py-16">
        <div className="container max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-6 text-gray-300">
            ...
            {/* 10. Facebook Platform Data */}
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                <div className="p-3 rounded-lg bg-blue-500/10 text-blue-400 shrink-0"><Share2 className="h-6 w-6" /></div>
                <div>
                  <h2 className="text-xl font-bold text-white mb-3">{lang === "en" ? "10. Facebook Platform Data" : "十、Facebook 平台数据"}</h2>
                  ...
                  <h3 className="text-lg font-medium text-white mt-4 mb-2">{lang === "en" ? "10.2 Purpose, Permissions, and Sharing" : "10.2 目的、权限与共享"}</h3>
            ...
            {/* 11. YouTube API Services and Google User Data */}
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                <div className="p-3 rounded-lg bg-red-500/10 text-red-400 shrink-0"><Youtube className="h-6 w-6" /></div>
                <div>
                  <h2 className="text-xl font-bold text-white mb-3">{lang === "en" ? "11. YouTube API Services and Google User Data" : "十一、YouTube API 服务与 Google 用户数据"}</h2>
                  ...
                  <h3 className="text-lg font-medium text-white mt-4 mb-2">{lang === "en" ? "11.1 Data We Process" : "11.1 我们处理的数据"}</h3>
                  ...
                  <h3 className="text-lg font-medium text-white mt-4 mb-2">{lang === "en" ? "11.2 Use and Sharing" : "11.2 使用与共享"}</h3>
                  ...
                  <h3 className="text-lg font-medium text-white mt-4 mb-2">{lang === "en" ? "11.3 Retention, Revocation, and Deletion" : "11.3 保留、撤权与删除"}</h3>
                  ...
                  <h3 className="text-lg font-medium text-white mt-4 mb-2">{lang === "en" ? "11.4 Google Policies and Limited Use" : "11.4 Google 政策与有限使用"}</h3>
