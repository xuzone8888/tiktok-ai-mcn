            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">{lang === "en" ? '2.1 You may use "ToryX" software and related services in the form of clients, webpages, etc. on terminals such as computers and mobile phones. The specific form provided by the Company shall prevail.' : '2.1 您可以在计算机、手机等终端设备上以客户端、网页等形式使用"ToryX"软件及相关服务，具体以公司提供的为准。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '2.2 The Company grants you a personal, non-transferable, and non-exclusive license to use "ToryX" software and related services. Without prior written authorization from the Company, you may not use it for commercial purposes.' : '2.2 公司授予您一项个人的、不可转让的、非独占的许可以使用"ToryX"软件及相关服务。未经公司事先书面授权，您不得将其用于商业目的。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '2.3 You can obtain this software from the Company\'s website or a third party authorized by the Company. If you obtain this software from a third party not authorized by the Company, the Company cannot guarantee that the software can be used normally.' : '2.3 您可以从公司网站或经公司授权的第三方获取该软件。如果您从未经公司授权的第三方获取本软件，公司无法保证该软件能够正常使用。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '2.4 In order to improve user experience and improve service content, the Company will continuously strive to develop new services and provide you with software updates from time to time.' : '2.4 为了改善用户体验和完善服务内容，公司将不断努力开发新服务，并不时向您提供软件更新。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '2.5 Unless you have prior written authorization from the Company, you may not access or use "ToryX" software and related services in any unauthorized form.' : '2.5 未经公司事先书面授权，您不得以任何未经授权的形式访问或使用"ToryX"软件及相关服务。'}</p>
                </div>
              </div>
            </ReflectiveCard>
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">{lang === "en" ? '3.1 "ToryX" software and related services provide you with a registration channel. You have the right to choose a legal character combination as your account and set a password that meets security requirements on your own.' : '3.1 "ToryX"软件及相关服务为您提供注册通道，您有权选择合法的字符组合作为自己的账户，并自行设定符合安全要求的密码。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '3.2 You understand and assume that the account you set shall not violate national laws and regulations and the relevant rules of the Company. Your account name, avatar, profile, and other registration information shall not contain illegal or undesirable information.' : '3.2 您理解并承诺，您设置的账户不得违反国家法律法规及公司的相关规则。您的账户名称、头像、简介等注册信息不得含有违法或不良信息。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '3.3 Your account is limited to your personal use. Without the written consent of the Company, it is prohibited to donate, borrow, rent, transfer, sell, or permit others to use the account in any other way.' : '3.3 您的账户仅限于您本人使用，未经公司书面同意，禁止以任何形式赠与、借用、出租、转让、售卖或许可他人使用该账户。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '3.4 You are responsible for maintaining the security and confidentiality of your personal account and password, and assume full legal responsibility for activities engaged in the name of your registered account.' : '3.4 您应负责维护个人账户和密码的安全性和保密性，对您以注册账户名义所从事的活动承担全部法律责任。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '3.5 If your account is lost or you forget your password, you can follow the Company\'s appeal channel to appeal for retrieval of the account or password.' : '3.5 如您的账户丢失或忘记密码，可以按公司的申诉通道进行申诉找回账户或密码。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '3.6 When registering, using, and managing your account, you should ensure the authenticity of the identity information filled in during registration.' : '3.6 在注册、使用和管理账户时，您应确保注册时填写的身份信息的真实性。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '3.7 In addition to self-registering an account, users can also authorize the use of user accounts of third-party software legally owned by them to log in and use "ToryX" software and related services.' : '3.7 除自行注册账户外，用户还可以授权使用其合法拥有的第三方软件用户账户登录使用"ToryX"软件及相关服务。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '3.8 After you complete account registration and login, you can browse and modify the submitted personal identity information at any time. You can also apply to cancel your account.' : '3.8 您完成账户注册和登录后，可随时浏览、修改自己提交的个人身份信息。您也可以申请注销您的账户。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '3.9 You understand and agree that in order to fully utilize account resources, if you fail to log in for the first time in time after registration or fail to log in and use the account for more than two consecutive months, the Company has the right to recall your account.' : '3.9 您理解并同意，为了充分利用账户资源，如您注册后未及时首次登录或连续超过两个月未登录使用账户，公司有权回收您的账户。'}</p>
                </div>
              </div>
            </ReflectiveCard>
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed mt-3">{lang === "en" ? 'For more content on your personal information protection, please refer to the "ToryX Privacy Policy".' : '有关您个人信息保护的更多内容，请参见《ToryX隐私政策》。'}</p>
                </div>
              </div>
            </ReflectiveCard>
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">{lang === "en" ? '6.1 Without written permission from the Company, you may not copy, read, adopt, or use the information content in "ToryX" software for commercial purposes, either by yourself or by authorizing, allowing, or assisting any third party.' : '6.1 未经公司书面许可，您不得自行或授权、允许、协助任何第三方复制、阅读、采用"ToryX"软件中的信息内容用于商业目的。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '6.2 With written permission from the Company, your sharing and forwarding of the information content shall also comply with relevant norms, and the original content shall not be tampered with or obscured.' : '6.2 经公司书面许可，您分享和转发信息内容时也应遵守相关规范，不得篡改或遮蔽原始内容。'}</p>
                </div>
              </div>
            </ReflectiveCard>
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">{lang === "en" ? '9.1 You understand and agree that the Company may push relevant information, advertising releases, or brand promotion services to you during your use of "ToryX" software and related services.' : '9.1 您理解并同意，公司可能在您使用"ToryX"软件及相关服务期间向您推送相关信息、广告发布或品牌推广服务。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '9.2 The Company fulfills relevant obligations for advertising and promotion. You should judge the authenticity and reliability of such advertising or promotion information yourself and be responsible for your own judgment.' : '9.2 公司履行广告和推广的相关义务。您应自行判断此类广告或推广信息的真实性和可靠性，并对您自己的判断负责。'}</p>
                </div>
              </div>
            </ReflectiveCard>
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">{lang === "en" ? '12.1 You understand and agree that "ToryX" software and related services may be affected or interfered with by various factors, and the Company does not guarantee that:' : '12.1 您理解并同意，"ToryX"软件及相关服务可能受到各种因素的影响或干扰，公司不保证：'}</p>
                  <ul className="list-disc pl-6 space-y-1 mt-3 text-gray-300 text-sm">
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">{lang === "en" ? '14.1 If you are a minor under the age of 18, you should use "ToryX" software and related services under the guardianship and guidance of your guardian and with the consent of your guardian, after carefully reading and agreeing to this Agreement.' : '14.1 如您是未满18周岁的未成年人，应在监护人的监护和指导下，在仔细阅读并同意本协议后，经监护人同意后使用"ToryX"软件及相关服务。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '14.2 The Company attaches importance to the protection of minors\' personal information. Minor users should strengthen their awareness of personal protection and treat it specifically when filling in personal information.' : '14.2 公司重视对未成年人个人信息的保护。未成年用户应增强个人保护意识，在填写个人信息时特别对待。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '14.3 Minor users and their guardians understand and confirm that if you violate laws and regulations or the content of this Agreement, you and your guardians shall bear all legal responsibilities that may result therefrom according to the law.' : '14.3 未成年用户及其监护人理解并确认，如您违反法律法规或本协议内容，您及您的监护人应依法承担由此可能产生的全部法律责任。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '14.4 Special Note for Minor Users: Teenagers should use "ToryX" software and related services correctly within a reasonable range under the supervision and guidance of their guardians, avoid addiction to virtual cyberspace, and develop good internet surfing habits.' : '14.4 未成年用户特别提示：青少年应在监护人的监督和指导下，在合理范围内正确使用"ToryX"软件及相关服务，避免沉迷网络虚拟空间，养成良好的上网习惯。'}</p>
                </div>
              </div>
            </ReflectiveCard>
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">{lang === "en" ? '15.1 The conclusion, effectiveness, performance, interpretation, and dispute resolution of this Agreement shall be governed by the laws of the People\'s Republic of China. If any provision is invalid or unenforceable, these terms shall be re-interpreted as closely as possible to the original intent.' : '15.1 本协议的订立、效力、履行、解释及争议解决均适用中华人民共和国法律。如有任何条款无效或不可执行，该条款应尽可能接近原意重新解释。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '15.2 The signing place of this Agreement is Wuhan, Hubei Province. If any dispute arises, both parties shall try to resolve it through friendly negotiation. If negotiation fails, you agree to submit the dispute to the People\'s Court where the Company is located.' : '15.2 本协议签订地为湖北省武汉市。如发生任何争议，双方应首先通过友好协商解决。如协商不成，您同意将争议提交至公司所在地的人民法院。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '15.3 In order to provide you with better services or due to adjustments in national laws, regulations, and policies, "ToryX" software and related services will be updated and changed from time to time, and we will revise this Agreement in due course. If you continue to use "ToryX", it means you have agreed to accept the revised content.' : '15.3 为向您提供更好的服务或因应国家法律法规及政策的调整，"ToryX"软件及相关服务将不时更新和变更，我们将适时修订本协议。如您继续使用"ToryX"，即表示您已同意接受修订后的内容。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '15.4 The headings in this Agreement are set for convenience and reading only and do not affect the meaning or interpretation of any provision.' : '15.4 本协议中的标题仅为方便阅读而设置，不影响任何条款的含义或解释。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '15.5 You and the Company are independent subjects. In no case does this Agreement constitute any form of express or implied guarantee, nor does it constitute an agency, partnership, joint venture, or employment relationship between the parties.' : '15.5 您与公司为独立主体。本协议在任何情况下均不构成任何形式的明示或暗示保证，也不构成双方之间的代理、合伙、合资或雇佣关系。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '15.6 The copyright of this Agreement belongs to the Company, and the Company reserves all rights of interpretation and modification.' : '15.6 本协议的著作权归公司所有，公司保留所有解释和修改的权利。'}</p>
                </div>
              </div>
            </ReflectiveCard>
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">{lang === "en" ? '16.1 Your authorization to use your TikTok account in "ToryX" software and related services shall be deemed as your agreement to TikTok\'s relevant terms of service.' : '16.1 您授权在"ToryX"软件及相关服务中使用您的TikTok账户，即视为您同意TikTok的相关服务条款。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? "Related Links:" : "相关链接："}</p>
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">{lang === "en" ? '17.1 Subscription Upgrade and Downgrade: When changing from one paid plan to another, the new plan will be prorated by calculating the remaining days of the two plans and their respective daily rates.' : '17.1 订阅升级和降级：从一个付费计划更改为另一个付费计划时，新计划将通过计算两个计划的剩余天数及其各自的日费率进行按比例计算。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '17.2 Fee Changes: We may change plan fees from time to time and will notify you in advance. Price changes will take effect at the beginning of the next subscription period. If you do not agree to the price change, you must cancel your subscription before the price change takes effect.' : '17.2 费用变更：我们可能会不时更改计划费用，并会提前通知您。价格变更将在下一个订阅期开始时生效。如果您不同意价格变更，您必须在价格变更生效前取消订阅。'}</p>
                  <p className="leading-relaxed mt-3">{lang === "en" ? '17.3 Subscription Cancellation: You can cancel your subscription at any time. After cancellation, your subscription will expire at the end of the current cycle. Paid fees are non-refundable.' : '17.3 订阅取消：您可以随时取消订阅。取消后，您的订阅将在当前周期结束时到期。已付费用不予退还。'}</p>
                </div>
              </div>
            </ReflectiveCard>
