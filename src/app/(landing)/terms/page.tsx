            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-loose mt-3">{lang === "en" ? '16.7 Data and Authorization Revocation: You may revoke Star Gaze\'s access through your TikTok account settings at any time. Use Disconnect in Star Gaze to remove the stored account connection and OAuth credentials. Publishing-task history and aggregate statistics remain until you delete the applicable task or submit a valid deletion request; limited security, legal-compliance, and dispute-resolution records may be retained only as described in our Privacy Policy.' : '16.7 数据和授权撤回：您可以随时通过 TikTok 账户设置撤回 Star Gaze 的访问授权。如需删除已存储的账号连接及 OAuth 凭据，请在 Star Gaze 中使用“断开连接”。发布任务历史和聚合统计会保留至您删除相应任务或提交有效的数据删除请求；有限的安全、法律合规及争议处理记录仅按照隐私政策所述方式保留。'}</p>
