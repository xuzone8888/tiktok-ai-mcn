    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <main className="relative z-10 py-16">
        <div className="container max-w-4xl mx-auto px-6">
          <div className="mb-12">
            <h1 className="text-4xl font-bold mb-4">{lang === "en" ? "Legal Notice - Wuhan Guanxing Cultural Media Co., Ltd. (Star Gaze)" : "法律声明 - 武汉观星文化传媒有限公司 (Star Gaze)"}</h1>
          ...
          <div className="space-y-6 text-gray-300">
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                <div className="p-3 rounded-lg bg-emerald-500/10 text-emerald-400 shrink-0"><Building className="h-6 w-6" /></div>
                <div>
                  <h2 className="text-xl font-bold text-white mb-3">{lang === "en" ? "Brand & Operator" : "品牌与运营主体"}</h2>
                  <p className="leading-relaxed">{lang === "en" ? "Star Gaze is a brand operated by Wuhan Guanxing Cultural Media Co., Ltd. TikTok is a third-party platform. Our services are independently operated by Wuhan Guanxing Cultural Media Co., Ltd." : "Star Gaze 为武汉观星文化传媒有限公司运营品牌。TikTok 为第三方平台，本平台服务由武汉观星文化传媒有限公司独立运营。"}</p>
                </div>
              </div>
            </ReflectiveCard>
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">{lang === "en" ? '1.1 The Star Gaze platform (hereinafter referred to as "this Platform") is operated and managed by Wuhan Guanxing Cultural Media Co., Ltd. (hereinafter referred to as "the Company").' : '1.1 Star Gaze 平台（以下简称"本平台"）由武汉观星文化传媒有限公司（以下简称"本公司"）运营和管理。'}</p>
            ...
            <ReflectiveCard className="!rounded-xl">
              <div className="flex items-start gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">{lang === "en" ? '2.1 The names, logos, icons, and related product/service names, logos, and identifications (collectively "Trademarks") used on this Platform are registered trademarks or trademarks of the Company.' : '2.1 本平台使用的名称、标志、图标及相关的商品/服务名称、标志、标识（统称"商标"）为本公司的注册商标或商标。'}</p>
        ...
        <div className="container max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-gray-500 text-sm">
              © {new Date().getFullYear()} {lang === "en" ? "Star Gaze by Wuhan Guanxing Cultural Media Co., Ltd. All rights reserved." : "Star Gaze · 武汉观星文化传媒有限公司 版权所有"}
            </div>
